...
REM Run SSH in background, redirecting output to log file
start /b "" ssh -o StrictHostKeyChecking=no -o ServerAliveInterval=10 -p 443 -R 80:localhost:8000 qr@a.pinggy.io > "%LOG_FILE%" 2>&1
